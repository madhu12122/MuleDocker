...
RUN cd /opt && unzip ~/mule-enterprise-standalone-4.3.0.zip && rm ~/mule-enterprise-standalone-4.3.0.zip && ln -s /opt/mule-enterprise-standalone-4.3.0 /opt/mule-enterprise-standalone-4.3.0
